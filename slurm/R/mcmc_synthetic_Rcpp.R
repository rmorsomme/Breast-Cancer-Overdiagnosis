...
# need original helpers to create simulated data
# The subsequent call to Rcpp helper will override the only needed function
# MCMC()
source("helpers.R")
Rcpp::sourceCpp("helpers_in_Rcpp.cpp")
source("helpers_for_calling_Rcpp.R")
